...
def traingloop(): 
    ...
    for epoch in range(10):
        ...
        for i in range(len(x)):
            # print("y before squeeze:", y[i])
            # print("x before squeeze:", x[i].shape)
            sample_x= x[i].unsqueeze(0)  # Add batch dimension to the input image
            sample_y= y[i].unsqueeze(0)  # Add batch dimension to the target
            # print("sample_y after squeeze:", sample_y)
            # print("sample_x after squeeze:", sample_x)
