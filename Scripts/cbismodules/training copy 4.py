...
# def train_model(model, train_loader, device, epochs=10, learning_rate=0.0001):
    ...
    for epoch in range(epochs):
        ...
        train_loss_history.append(round(epoch_loss, 2))
        train_accuracy_history.append(round(epoch_accuracy, 2))
        # print(
        ...
        val_loss_history.append(round(epoch_avg_val_loss, 2))
        val_accuracy_history.append(round(accuracy_percentage, 2))
