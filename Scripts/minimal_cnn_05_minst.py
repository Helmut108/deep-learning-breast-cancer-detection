...
def prepare_data():
    ...
    # to match the 128x128 architecture size of the MVP model
...
def train_model(model, train_loader, device, epochs=10, learning_rate=0.0001):
    ...
    print("--- BASIC TRAINING LOOP DATALOADER---")
    ...
    for epoch in range(epochs):
        for batch_idx, (real_images, real_targets) in enumerate(train_loader):
            ...
            # abd we no longer use dummy data, we use the real data from the dataloader
    ...
    print("The basic training with DataLoader functional!")
