...
for epoch in range(10):
    ...
    for i in range(len(x)):
        ...
        x= x[i].unsqueeze(0)  # Add batch dimension to the input image
        y= y[i].unsqueeze(0)  # Add batch dimension to the target
        print("y after squeeze:", y[i])
        print("x after squeeze:", x[i].shape)
